...
- (SCKIvar*)ivarForName: (NSString*)name
{
    ...
    [ivars enumerateObjectsUsingBlock:^(SCKIvar *ivar, NSUInteger idx, BOOL * __nonnull stop) {
...
{
     NSMutableArray *arr = [NSMutableArray array];
    [properties enumerateObjectsUsingBlock:^(SCKProperty *prop, NSUInteger idx, BOOL * __nonnull stop) {
...
- (SCKProperty*)requiredPropertyForName: (NSString*)name
{
    ...
    NSMutableArray *arr = [NSMutableArray array];
    [requiredProperties enumerateObjectsUsingBlock:^(SCKProperty *prop, NSUInteger idx, BOOL * __nonnull stop) {
        if ([[prop name] isEqualToString: name]) {
            [arr addObject:prop];
        }
    }];
...
- (SCKProperty*)optionalPropertyForName: (NSString*)name
{
    ...
    NSMutableArray *arr = [NSMutableArray array];
    [optionalProperties enumerateObjectsUsingBlock:^(SCKProperty *prop, NSUInteger idx, BOOL * __nonnull stop) {
        if ([[prop name] isEqualToString: name]) {
            [arr addObject:prop];
        }
    }];
